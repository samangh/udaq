...
#include <udaq/wrappers/c/globals.h>
...
C_WRAPPER_EXPORT safibra_client safibra_create_client(safibra_error_cb_t erro_cb,
...
C_WRAPPER_EXPORT void safibra_start(safibra_client client, int port);
C_WRAPPER_EXPORT void safibra_stop(safibra_client client);
C_WRAPPER_EXPORT bool safibra_is_running(safibra_client client);

C_WRAPPER_EXPORT safibra_packet_buffer safibra_get_buffer(safibra_client client);

C_WRAPPER_EXPORT void safibra_free_buffer(safibra_packet_buffer buffer);
C_WRAPPER_EXPORT void safibra_free_client(safibra_client client);

C_WRAPPER_EXPORT int safibra_number_of_clients(safibra_client client);
